...
export const SandboxApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @param {string} [name] Filter by name prefix (case-sensitive). Can not be combined with \&quot;states\&quot;
...
export const SandboxApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    listSandboxes(
      ...
      return localVarFp
        .listSandboxes(xDaytonaOrganizationID, cursor, limit, name, includeErroredDeleted, states, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *

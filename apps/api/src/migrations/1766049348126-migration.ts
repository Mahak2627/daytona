...
export class Migration1766049348126 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // sandbox list with case-sensitive name prefix filter
    await queryRunner.query(`
      CREATE INDEX CONCURRENTLY idx_sandbox_org_name_prefix_created
      ON sandbox ("organizationId", name varchar_pattern_ops, "createdAt" DESC)
    `)
  }

...
export class SandboxOpenSearchAdapter implements SandboxSearchAdapter, OnModuleInit {
        ...
        body: {
          ...
          mappings: {
            ...
            properties: {
              ...
              labels: { type: 'flattened' as const as any },
  ...
  async search(
    ...
    return this.processSearchResponse(response, limit, sortField)
  }
  ...
  private buildSearchBody(
    ...
    const searchBody: Search_RequestBody = {
      query,
      sort: [{ [opensearchSortField]: { order: sortDirection } }, { _id: { order: 'desc' } }],
